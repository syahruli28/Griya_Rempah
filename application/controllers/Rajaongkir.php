...
class Rajaongkir extends CI_Controller {
    ...
    public  function provinsi()
    {
        ...
        if ($err) {
            ...
            {
                // echo "<option value='".$dp['province_id']."' id_provinsi='". $dp['province_id'] ."'>". $dp['province'] ."</option>"; aslinya
    ...
    public function kota()
    {
        ...
        if ($err) {
            ...
            {
                // echo "<option value='".$dk['city_id']."' id_kota='".$dk['city_id']."' >". $dk['city_name'] ."</option>"; aslinya
    ...
    {
        $id_lok = $this->Slogin_model->lokasiId()->kota_kabupaten;
