...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-5">
        <h1 class="h3 mb-0 text-gray-800">Tambah Data Testimoni</h1>
    ...
    <div class="row">
        <div class="col-6">
        <?= form_open_multipart('Slogin/TambahTestimoni'); ?>
            <div class="form-group">
                <label for="namat">Nama</label>
                <input type="text" class="form-control" name="namat" id="namat">
    ...
    <div class="row">
        <div class="col">
            <div class="form-group">
                ...
                <textarea name="kalimatt" id="kalimatt" cols="30" rows="10" class="form-control"></textarea>
