...
<div id="content">
    ...
    <?= form_open('', $attr); ?>
        <div class="input-group">
            <input type="text" class="form-control bg-light border-0 small" placeholder="Masukkan Tanggal (Y-m-d)"
...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4 print">
        <h1 class="h3 mb-0 text-gray-800">Data Pesanan Selesai</h1>
        <button class="btn btn-sm tombol-produk" onclick="window.print()">
        ...
        <div class="col">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="print">Opsi</th>
                        </tr>
                        </thead>
                        ...
                        <?php foreach( $pesanan as $p ): ?>
                            ...
                            <td>
                                ...
                                <?php $tot_dapat = $tot_dapat + $p['total_bayar'] ; ?>
                            </td>
                            <td>
                                <?= html_escape($p['tanggal_bayar']) ;?>
                            </td>
                            <td class="print">
                                <a href="<?= base_url(); ?>Slogin/HalamanFormValidasiPembayaran/<?= $p['no_order']; ?>" class="btn">
                        ...
                        <div class="invoice">
                            <tr>
                                <td colspan="3" class="text-uppercase invoice">Total</td>
                                <td class="invoice">Rp <?= number_format($tot_dapat,0,',','.') ;?></td>
                            </tr>
                        </div>
