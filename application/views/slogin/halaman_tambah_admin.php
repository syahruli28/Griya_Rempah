...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="notelpadmin" id="notelpadmin">
    ...
    <div class="row">
        <div class="col-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="emailadmin" id="emailadmin">
                <small class="form-text text-danger"><?= form_error('emailadmin'); ?></small>
            </div>
        </div>
        <div class="col-6">
            <label for="passwordadmin1">Masukan Password</label>
    ...
    <div class="row">
        <div class="col-6">
            <label for="passwordadmin2">Konfirmasi Password</label>
