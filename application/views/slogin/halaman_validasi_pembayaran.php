    ...
    <!-- AKHIR TABEL CART -->
                ...
                <input type="hidden" name="noorder" id="noorder" value="<?= $pesanan['no_order']; ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php if($pesanan['bukti_bayar'] == FALSE ) :?>
                            <?php else :?>
        ...
        <div class="row mb-5 mt-5">
            <div class="col-md-12 print">
                <div>
                    <a href="<?= base_url();?>Slogin/HalamanAntrianPesanan" class="btn btn-sm tombol-detail-produk">Batalkan</a>
                    <a class="btn btn-sm tombol-detail-produk" onclick="window.print()"><i class="fas fa-print" style="color: #5D4954;"></i> Print</a>
