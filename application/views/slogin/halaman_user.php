...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?= base_url();?>Slogin/TambahUser" class="d-none d-sm-inline-block btn btn-sm shadow-sm" style="background-color: #5D4954; color: #fff;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    Data User <strong>berhasil</strong> <?= $this->session->flashdata('msg-success'); ?> .
        ...
        <div class="col">
                    <table class="table">
                        ...
                        <?php foreach( $user as $u ): ?>
                            ...
                            <td><?= html_escape($u['nama_user']) ;?></td>
                            <td><?= html_escape($u['no_telp_user']) ;?></td>
                            <td><?= html_escape($u['email_user']) ;?></td>
                            <td>
                                <a href="<?= base_url(); ?>Slogin/UbahDataUser/<?= $u['id_user']; ?>" class="btn">
                                    <i class="fas fa-edit"></i>
                                Edit</a> | 
                                <a href="<?= base_url(); ?>Slogin/HapusUser/<?= $u['id_user']; ?>" onclick="return confirm('Apa anda yakin ?');" class="btn tombol-detail-produk">
