...
<div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    Data testimoni <strong>berhasil</strong> <?= $this->session->flashdata('msg-success'); ?> 
                </div>
            </div>
        </div>
    <?php endif; ?>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Testimoni Produk</h1>
        <a href="<?= base_url();?>Slogin/TambahTestimoni" class="d-none d-sm-inline-block btn btn-sm shadow-sm" style="background-color: #5D4954; color: #fff;">
        ...
        <div class="col">
                    <table class="table">
                        ...
                        <?php foreach( $testimoni as $t ): ?>
                            ...
                            <td>
                            <img src="<?= base_url('assets/griyarempah/img/gambarweb/') . html_escape($t['gambar_testimoni']); ?>" width="120" height="90">
                            </td>
                            <td><?= html_escape($t['nama_testimoni']) ;?></td>
                            <td><?= html_escape($t['kalimat_testimoni']) ;?></td>
                            <td>
                                <a href="<?= base_url(); ?>Slogin/UbahDataTestimoni/<?= $t['id_testimoni']; ?>" class="btn">
                                    <i class="fas fa-edit"></i>
                                Edit</a> | 
                                <a href="<?= base_url(); ?>Slogin/HapusDataTestimoni/<?= $t['id_testimoni']; ?>" onclick="return confirm('Apa anda yakin?');" class="btn tombol-detail-produk">
